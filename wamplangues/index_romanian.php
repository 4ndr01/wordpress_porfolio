...
$langues = array(
	...
	'nolocalhost' => 'Nu este o idee bună sa adăugaţi localhost în adresa (media-ul) proiectelor. Este recomandată definirea unui VirtualHost corespunzător în fişierul<br />wamp/bin/apache/apache%s/conf/extra/httpd-vhosts.conf<br />şi evitarea folosirii localhost în adrese (media).',
	);
?>