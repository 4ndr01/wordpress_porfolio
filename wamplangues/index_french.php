...
$langues = array(
	...
	'nolocalhost' => 'C\'est une mauvaise idée d\'ajouter localhost dans les media de lancement des projets. Il est préférable de définir des VirtualHost dans le fichier<br />wamp/bin/apache/apache%s/conf/extra/httpd-vhosts.conf<br />et de ne pas ajouter localhost dans les media.',
	);
?>